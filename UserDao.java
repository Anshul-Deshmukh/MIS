	...
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root", "Anshul");
	}
	...
	try{
	Connection con=getConnection();
	PreparedStatement ps=con.prepareStatement("update record set name=?, password=?, email=?,country=? where id=?");
